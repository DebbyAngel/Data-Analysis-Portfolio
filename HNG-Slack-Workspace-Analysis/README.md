...
- **HNG13 Slack Analytics Dataset (Oct 1 – Dec 6, 2025)**  
  Raw daily Slack workspace data containing engagement metrics such as active users, messages, files shared, and membership statistics.

- **HNG13_Engineered_Dataset**  
  Feature-engineered dataset derived from the raw data, including lag features, rolling averages, ratios, and time-based variables used for modeling.

- **HNG13_predictions**  
  Output files containing model predictions for daily active users generated during the predictive analysis stage.

- **Pulse_Analytics_Exploratory & Predictive_Analysis_Jupyter_Notebook.pdf**  
  Complete Jupyter Notebook documenting data cleaning, exploratory analysis, feature engineering, model training, evaluation, and visualizations.

- **Pulse_Analytics_Exploratory & Predictive_Analysis_Report.pdf**  
  Detailed analytical report summarizing methodology, insights, model performance, and conclusions.
